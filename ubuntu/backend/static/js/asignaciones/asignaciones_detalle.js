                              ...
                              <div class="row g-1 justify-content-center m-2 mt-0">
                                  ...
                                  <div class="col-12 col-md-4">
                                    <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start text-detalle-unidad">Tipo Dominio</div>
                                      <div class="text-start detalle-uc-value">${tipoDominio}</div>
                                    </div>
                                  </div>

                                  <div class="col-12 col-md-4">
                                    <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start text-detalle-unidad">Total mezaninis</div>
                                      <div class="text-start detalle-uc-value">${totalMezaninis}</div>
                                    </div>
                                  </div>

                                  <div class="col-12 col-md-4">
                                    <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start text-detalle-unidad">Etiqueta</div>
                                      <div class="text-start detalle-uc-value">${etiqueta}</div>
                                    </div>
                                  </div>

                                  <div class="col-12 col-md-4">
                                    <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start text-detalle-unidad">Total Pisos</div>
                                      <div class="text-start detalle-uc-value">${totalPisos}</div>
                                    </div>
                                  </div>

                                  <div class="col-12 col-md-4">
                                    <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start text-detalle-unidad">Total Semisótanos</div>
                                      <div class="text-start detalle-uc-value">${totalSemisotanos}</div>
                                    </div>
                                  </div>

                                  <div class="col-12 col-md-4">
                                    <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start text-detalle-unidad">Estado Construcción</div>
                                      <div class="text-start detalle-uc-value">${estadoConstruccion}</div>
                                    </div>
                                  </div>

                                  <div class="col-12 col-md-4">
                                    <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start text-detalle-unidad">Total Sótanos</div>
                                      <div class="text-start detalle-uc-value">${totalSotanos}</div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-12 col-md-4">
                                    <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start text-detalle-unidad">Observación</div>
                                      <div class="text-start detalle-uc-value">${observacion}</div>
                                    </div>
                                  </div>
              ...
              <tr class="fila-detalle-unidad-card">
                  <td colspan="5" class="p-0 border-0">
                      <div class="collapse collapse-detalle-uc-card-edit" id="${rowId}">
                          <div class="detalle-unidad-card-contenido " style="padding:0.5rem !important">
                          
                              <div class="row g-1 justify-content-center m-2 mt-0">

                               <div class="col-12 col-md-4">
                                  <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start tex-num">Tipo de planta</div>
                                      <div class="text-start dato_info">${tipoPlanta}</div>
                                  </div>
                                </div>
                  
                                <div class="col-12 col-md-4">
                                  <div class="d-flex flex-column w-100 dato p-2">
                                      <div class="fw-bold text-start tex-num">Relación Superficie</div>
                                      <div class="text-start dato_info">${relacionSuperficie}</div>
                                  </div>
                                </div>
                                
                                <div class="col-12 col-md-4">
                                  <div class="d-flex flex-column w-100 dato p-2 ">
                                      <div class="fw-bold text-start tex-num">Estado U. Construcción</div>
                                      <div class="text-start dato_info">${estadoUnidad}</div>
                                  </div>
                                </div>
                  
                                <div class="col-12 col-md-4">
                                  <div class="d-flex flex-column w-100 dato p-2 ">
                                      <div class="fw-bold text-start tex-num">Etiqueta</div>
                                      <div class="text-start dato_info">${etiqueta}</div>
                                  </div>
                                </div>
                  
                                <div class="col-12 col-md-8">
                                  <div class="d-flex flex-column w-100 dato p-2 ">
                                      <div class="fw-bold text-start tex-num">Observaciones</div>
                                      <div class="text-start dato_info observaciones-unidad-card">${observaciones}</div>
                                  </div>
                                </div>
                  
                                <div class="col-12 col-lg-12 text-end">
                                  <div class="detalle-uc-acciones d-flex justify-content-center align-items-center  py-3">
                                    <button
                                      type="button"
...
async function loadUnidadExtraEdit(unitId) {
  if (!unitId) return;
  try {
    const params = new URLSearchParams({ unidad_id: String(unitId) });
    if (asigSchemaWork) {
...
function poblarOffcanvasConvencionalEdit(detalle = {}) {
  ...
  setTextByIdEdit("convencionalTotalBanios", car?.total_banios);
...
function renderEmptyMarcasAsignacionEdit(selector, mensaje) {
  const contenedor = document.querySelector(selector);
  if (!contenedor) return;
  contenedor.innerHTML = `<div class="text-center text-muted py-3">${esc(mensaje)}</div>`;
}
...
function limpiarModalMarcasAsignacionEdit() {
  renderModalMarcasAsignacionEdit({});
}
...
function setPredioConditionAccordionVisibilityEdit(
  ...
  if (trigger) {
    trigger.classList.toggle("d-none", !isVisible);
...
function obtenerIdOperacionPredioEdit(predio = {}, detalle = {}) {
  const predioDetalle = detalle?.predio || {};
  const valor = [
    predioDetalle?.id_operacion,
    predio?.id_operacion,
...
function limpiarResumenPredioEdit() {
  ...
  setText("resumenPredioDireccion", "-");
  ...
  limpiarModalMarcasAsignacionEdit();
}
...
function marcarResumenPredioCargandoEdit(predio = {}) {
  setText("resumenPredioOperacionId", obtenerIdOperacionPredioEdit(predio));
...
async function aplicarDetallePredioSeleccionadoEdit(predio, detalle = {}) {
  ...
  renderModalMarcasAsignacionEdit(detalle);
